...
<div class="container">
		<form class="form-horizontal" method="post"
			action="../common/request_edit_status.php">
			...
			$sql="select id,name from request where id=?";
			db_bind_param($sql, 1, $_REQUEST["id"], 'STRING');
			...
			<div class="form-group">
				<label class="control-label col-md-3">问卷</label>
				<div class="col-md-6">
