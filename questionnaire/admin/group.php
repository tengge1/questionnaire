...
<body>
	...
	$array = grp_get_all_group ( $con );
	echo '<h4 style="display:inline-block;">用户组管理</h4>';
	echo '<a class="btn btn-default" style="float:right;" href="../admin/group_add.php?category=用户组管理">添加用户组</a>';
...

	{
		...
		echo '<td><a href="../admin/group_edit.php?category=用户组管理&id=' . $type ["id"] . '">修改</a></td>';
		echo '<td><a href="../admin/group_remove.php?category=用户组管理&id=' . $type ["id"] . '">删除</a></td>';
		echo '</tr>';
	}
	echo '</tbody>';
	echo '</table>';
